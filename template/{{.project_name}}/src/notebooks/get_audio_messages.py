...
dbutils.widgets.text(
    ...
    "{{secrets/mingyu/openai-test}}",
    label="OpenAI Secret Key Reference",
)

dbutils.widgets.text(
    "input_prompt_1",
    "Is this message about external models?",
    label="First Prompt",
)

dbutils.widgets.text(
    "input_prompt_2",
    "Can we use Databricks Model Serving Provider?",
    label="Second Prompt",
)
...
headers = {"Authorization": f"Bearer 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"}
...
headers = {"Authorization": "Bearer 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", 
...
dbutils.notebook.exit(audio_text +",:,"+ audio_summary)
